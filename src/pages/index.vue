<template>
    ...
    <div class="hero-content text-center">
      <div class="max-w-xl">
        ...
        <p data-aos="fade-down" data-aos-delay="300" class="md:text-lg mb-6">
          Nuxtwind Daisy is a starter template project for Nuxt.js 3 + Tailwind CSS + Daisy UI with
          additional installed setup for custom font, icons, animation, and more.
        </p>
  ...
  <generic-panel>
    <div class="flex flex-col">
      ...
      <p class="md:text-lg">
        Create beautiful and fast websites without worrying about the tedious setup. Just fork this
  ...
  <generic-panel>
    <div class="flex flex-col">
      ...
      <p class="md:text-lg">
        Read
        <a href="https://github.com/OSSPhilippines/nuxtwind-daisy#readme" class="text-primary"
          >the documentation</a
        >
  ...
  <generic-panel>
    <div class="flex flex-col">
      ...
      <p class="md:text-lg">
        See what you can do below. Basically, every basic thing that you need is already included in
        this starter template project. From custom font, icons, animations, and more.
      </p>
    </div>
  </generic-panel>
  ...
  <generic-panel>
    <div class="flex flex-col mb-5">
      ...
      <p class="md:text-lg">
        ...
        <a class="text-primary" href="https://icons8.com/line-awesome" target="_blank"
  ...
  <generic-panel>
    <div class="flex flex-col mb-5">
      ...
      <p class="md:text-lg">
        Check
        <a class="text-primary" href="https://michalsnik.github.io/aos/" target="_blank"
  ...
  <generic-panel>
    <div class="flex flex-col mb-5">
      ...
      <p class="md:text-lg">
        ...
        <a class="text-primary" href="https://daisyui.com/" target="_blank">daisyUI documentation</a
        >.
      </p>
    </div>
    <div class="flex flex-col">
  ...
  <generic-panel>
    <div class="flex flex-col">
      ...
      <p>
        Visit the official
        <a href="https://daisyui.com/docs/install/" target="_blank" class="text-primary"
